...
public class IOList {
    ...
    public void initialize(String name, SharedPreferences preferences) {
    ...
    public void clearData() {
        ...
        editor.putString(name + "packingItems", "");
        editor.apply();
        packingItems.clear();
        listOfCategories.clear();
        listOfPeople.clear();
    ...
    private void writePackingItemsToFile() {
        ...
        SharedPreferences.Editor editor = preferences.edit();
        editor.putString(name + "packingItems", output);
        editor.apply();
    }
    ...
    private void readPackingItemsFromFile() {
        String packingItemsString = preferences.getString(name + "packingItems", "").trim();
